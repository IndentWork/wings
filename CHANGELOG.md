...
- Chain validate after bootstrap via workflow_run
  ([`72ee191`](https://github.com/ASHISH-ARORA-24/wings/commit/72ee1915460c79634947693840887634e4da8c13))
...
- Enable workflow_dispatch and use creds JSON for SP auth
  ([`c4ed6a9`](https://github.com/ASHISH-ARORA-24/wings/commit/c4ed6a9d96ffdf56eaf7d77e8629a41d2fdf34a3))
...
- Pin astral-sh/setup-uv to v8.1.0
  ([`8ff276a`](https://github.com/ASHISH-ARORA-24/wings/commit/8ff276ad300f655755d0b817394fafbd538f9062))

Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>

- Upgrade actions to Node.js 24 compatible versions
  ([`260355d`](https://github.com/ASHISH-ARORA-24/wings/commit/260355d6673d7ff9bded6935bb21b35b7dba7bc7))
...
- Use creds JSON for azure/login v3 SP auth
  ([`c258e0e`](https://github.com/ASHISH-ARORA-24/wings/commit/c258e0ee1aea50912b5f2d987a55ae4795792c5a))
...
- Upgrade azure/login to v3 for Node.js 24 support
  ([`68e2441`](https://github.com/ASHISH-ARORA-24/wings/commit/68e2441b306da7d116183a7198cb9c67c5d4cdb5))
...
- Upgrade azure/login to v3 with updated input format
  ([`42da2b5`](https://github.com/ASHISH-ARORA-24/wings/commit/42da2b5835fe644e18522f8d365e191e7ebd21aa))
...
- Add CI/CD pipeline architecture plan
  ([`9c98da3`](https://github.com/ASHISH-ARORA-24/wings/commit/9c98da3d41777f50859e743145f603d2aa33ec2e))
...
- Add destroy.yml stage to pipeline architecture
  ([`64600cb`](https://github.com/ASHISH-ARORA-24/wings/commit/64600cbf6507262a5c566f586028612c3b7672c3))
...
- Consolidate deploy stages into single deploy.yml
  ([`b4910db`](https://github.com/ASHISH-ARORA-24/wings/commit/b4910dbb3b20f2f96572c3a5eade83974438b006))
...
- Update pipeline architecture with Bootstrap/Build/Deploy naming
  ([`5961f1a`](https://github.com/ASHISH-ARORA-24/wings/commit/5961f1a024e4fc67b4311725af6c7140012630de))
...
- Add .env to .gitignore
  ([`9362835`](https://github.com/ASHISH-ARORA-24/wings/commit/9362835b4f49aee161ae6979bb764856128a13a7))

Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>

- Add bootstrap preparation pipeline and docs
  ([`60ebb62`](https://github.com/ASHISH-ARORA-24/wings/commit/60ebb62b914d8ae227e1f238624cb67d6fd42805))
...
- Add CI workflow with Django tests and linting
  ([`2884a41`](https://github.com/ASHISH-ARORA-24/wings/commit/2884a41e54051ed03ce650a690701b547c02077b))
...
- Add pytest-django with basic smoke test
  ([`1bf9f9b`](https://github.com/ASHISH-ARORA-24/wings/commit/1bf9f9beb2d603cefb982e6ebc58d45e6b8a2566))
...
- Add python-semantic-release for versioning and changelog
  ([`2fc61e8`](https://github.com/ASHISH-ARORA-24/wings/commit/2fc61e820e7806a677d5dca0374d553e44b9e1c3))
...
- Enable GitHub Release creation on version bump
  ([`f7060e6`](https://github.com/ASHISH-ARORA-24/wings/commit/f7060e6defd6300654b87bfe77f7ed28a83eef8c))
...
- Rename and restructure Bootstrap and Build workflows
  ([`366a452`](https://github.com/ASHISH-ARORA-24/wings/commit/366a45267733ca87070540b8be4b6f33d4f0127c))
...
- Split build into validate and build stages
  ([`d12f53f`](https://github.com/ASHISH-ARORA-24/wings/commit/d12f53f54f30da8b6bfabce9c577d00286506df1))
